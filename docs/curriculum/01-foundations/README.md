...
- Install and use the .NET SDK and CLI confidently.
...
- Variables, types, operators, and conversions
- Control flow and methods
- Nullability and debugging basics
...
- [06 Study Session Planner Lab](../../../labs/01-foundations/06-study-session-planner-lab/README.md) combines the full Stage 1 topic set into one learner project.
- Starter assets: [starter](../../../labs/01-foundations/06-study-session-planner-lab/starter/)
- Reference implementation: [solution](../../../labs/01-foundations/06-study-session-planner-lab/solution/DotnetAcademy.StudySessionPlannerLab/)
- Tests: [DotnetAcademy.StudySessionPlannerLab.Tests](../../../tests/01-foundations/06-study-session-planner-lab/DotnetAcademy.StudySessionPlannerLab.Tests/)
