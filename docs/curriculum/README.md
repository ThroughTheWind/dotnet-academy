...
- Use `BACKLOG.md` when you need implementation order rather than learner-facing navigation.
...
- Stage 2 now includes four complete topic bundles covering object modeling plus the first abstraction topics.
