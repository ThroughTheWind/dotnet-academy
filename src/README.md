...
This directory contains runnable demos and reference implementations aligned to the curriculum stages.

## How To Use This Folder

- Use demos after you read the lesson and attempt the exercises for a topic.
- Topic demos usually map one-to-one with a curriculum topic.
- Integrated demos combine several topics into one reference solution.
...
- Stage 4: [curriculum index](../docs/curriculum/04-runtime-tooling-and-diagnostics/README.md) with the first two runtime tooling demos in [04-runtime-tooling-and-diagnostics/](./04-runtime-tooling-and-diagnostics/).
